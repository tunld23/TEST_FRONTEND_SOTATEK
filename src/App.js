  ...
  return (
    <div className="box">
      <div className="box-title">
        ...
        <div>
          <button
            className="box-title-btn-detail"
            onClick={() => setIsOpen(!isDetailOpen)}
          >
            Detail
          </button>
          <button className="box-title-btn-remove" onClick={onRemove}>
            Remove
          </button>
        </div>
      </div>
      ...
      <div className="right">
        ...
        {selected.length > 0 && (
          <div className="line-last">
            ...
            <div>
              <button className="line-last-btn-done">Done</button>
              <button onClick={onRemoveAll} className="line-last-btn-remove">
                Remove
              </button>
            </div>
          </div>
